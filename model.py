...
app = Flask(__name__)
app.config['MONGOALCHEMY_DATABASE'] = 'tradingfishery'
app.config['MONGOALCHEMY_CONNECTION_STRING'] = 'mongodb://localhost:27017/tradingfishery'
db = MongoAlchemy(app)
